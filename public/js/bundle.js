...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, passord) {
    var res;
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "data" ? "http://localhost:3000/api/v1/users/updateMe" : "http://localhost:3000/api/v1/users/updateMyPassword"; // console.log("hello");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"app.js":[function(require,module,exports) {
"use strict";
